import { clamp, interpolate } from 'https://unpkg.com/ixfx/dist/numbers.js';
...
const setup = () => {
  ...
  document.querySelector(`#slider`)?.addEventListener(`input`, event => {
    ...
    // movingAverageLight (discussed here: https://clinth.github.io/https://unpkg.com/ixfx/dist-docs/data/averaging/) would be useful.
