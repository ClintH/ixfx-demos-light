import {PointTracker, TrackedPointMap, pointsTracker} from 'https://unpkg.com/ixfx/dist/data.js';
...
export class PoseTracker {
   ...
   * @param {string} fromId
   * @param {string} poseId 
   * @param {import('https://unpkg.com/ixfx/dist/data.js').TrackedValueOpts} options 
   */
